...
if(isset($_POST['save']))
{
 ...
 $sql_note = "INSERT INTO notes(id, nom, note, email, mdp) VALUES(NULL,'$nom','$note', '$email','$mdp')";
...
required="required"><br>
Email : <input type="email" name="email" step="any"
required="required"><br>
Mot de passe : <input type="password" name="mdp" step="any"
required="required"><br>
